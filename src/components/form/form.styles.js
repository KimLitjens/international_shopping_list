const styles = {
    ...
    passwordInput: [
        `block border border-grey-light p-3 rounded mb-4 w-full`
    ],
    inputIcon: [
        `h-5 w-5 absolute left-auto right-3 top-4`
    ],
    Error: [
        `text-red-500 my-1`
    ],
    ...
    Link: [
        `no-underline border-b border-blue text-blue-500 ml-1`
    ],
}
